...
# Rigid-soft Divide-and-Truncate (DAT) truncation.
#
...
#
# The kernels consume only the ``Contacts`` record fields the collision pipeline's
# particle and edge/face passes emit (shape id, stored surface point and normal, soft
# feature indices + barycentrics) plus reference/candidate poses.
# =====================================================================================
