...
CLOTH_SIZE = 0.3
CLOTH_DIM = 15
# Separated initialization (keep for restoring after the temporary legacy run):
...
# Legacy initialization, temporarily active. Keep these values in comments if
# the separated initialization above is re-enabled in the future.
